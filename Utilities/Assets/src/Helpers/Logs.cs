...
namespace HelperPSR.Logs
{
    public static class Logs
    {
        ...
        [Conditional("DEBUG")]
        public static void Log(string title, string log, LogType logType = LogType.Log,
            LogColors titleColor = LogColors.None, LogColors logColors = LogColors.None)
        {
            title = $"<b>[{title}]</b>";
